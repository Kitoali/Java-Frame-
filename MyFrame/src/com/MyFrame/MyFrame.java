...
public class MyFrame extends JFrame 
{
	...
	MyFrame() 
	{
		...
		this.setLayout(null);
		this.add(textLeft);
		this.setBounds(550, 200, 400, 400);
		textLeft.setBounds(20, 20, 150, 250);
		textLeft.setVisible(true);
		this.add(textRight);
		textRight.setBounds(220, 20, 150, 250);
		textRight.setVisible(true);
		textRight.setEditable(false);
		this.add(buttonLeft);
		buttonLeft.setBounds(20, 300, 150, 20);
		...
		buttonRight.setBounds(220, 300, 150, 20);
